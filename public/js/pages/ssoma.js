...
export async function resourcesPage(root){
  ...
  <section class="panel"><div class="page-head compact"><div><h3>Control RACS por unidad</h3><p>Plazos institucionales: ALTO 0–48 horas · MEDIO 1–3 días · BAJO 1–4 días. Levantados sin evidencia: se separan entre “No requiere evidencia” y “Sin sustento”.</p></div><button class="btn amber" id="racControlExcel">Excel Control RACS por unidad</button></div><div id="racControlKpis"></div><div id="racControlTable"><div class="page-loading"><span class="spinner"></span>Cargando control…</div></div></section>
