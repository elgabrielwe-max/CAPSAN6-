...
export async function initSchema() {
  ...
  await q(`INSERT INTO schema_migrations(version) VALUES('4.0.40') ON CONFLICT DO NOTHING`);
  await q(`INSERT INTO schema_migrations(version) VALUES('4.0.41') ON CONFLICT DO NOTHING`);
